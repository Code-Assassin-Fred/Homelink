...
const services = [
  ...
  },
  {
    ...
    href: "/services/diaspora-concierge",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {services.map((service) => (
            <Link
              key={service.title}
              href={service.href}
              className="group bg-offwhite rounded-2xl p-8 border-l-4 border-offwhite hover:border-jade transition-all duration-300 hover:shadow-lg"
            >
              <div className="w-14 h-14 rounded-xl bg-forest flex items-center justify-center text-lime mb-6 group-hover:bg-jade transition-colors duration-300">
                {service.icon}
              </div>
              <h3 className="font-heading font-bold text-forest text-xl mb-3 group-hover:text-jade transition-colors duration-200">
                {service.title}
              </h3>
              <p className="text-charcoal text-sm leading-relaxed mb-4">
                {service.description}
              </p>
              <span className="inline-flex items-center gap-1 text-jade font-heading font-semibold text-sm group-hover:gap-2 transition-all duration-200">
                Learn More
