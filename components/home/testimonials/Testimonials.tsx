      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-2xl mx-auto text-center">
          <div className="bg-white rounded-3xl p-8 sm:p-12 lg:p-16">
            {/* Large Quote Icon */}
            <svg className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 text-lime mx-auto mb-6 sm:mb-8" fill="currentColor" viewBox="0 0 24 24">
            ...
            <h3 className="font-heading font-bold text-forest text-xl sm:text-2xl mb-4">
              Testimonials Coming Soon
            </h3>
            <p className="text-charcoal text-sm sm:text-base leading-relaxed mb-6 sm:mb-8">
